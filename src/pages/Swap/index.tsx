...
export function Swap({
  ...
  const handleSwap = useCallback(() => {
    ...
    ReactGA.event({
      category: 'Users',
      action: 'Confirm_swap_button_pushed',
    })
    swapCallback()
      .then((result) => {
        setSwapState((currentState) => ({
  ...
  useEffect(() => {
    ...
    //   ...trace,
    // })
  }, [prevTrade, trade, allowedSlippage, swapQuoteLatency, outputFeeFiatValue])
          ...
          {swapIsUnsupported ? (
            ...
            <ButtonLight
              onClick={() => {
                ReactGA.event({
                  category: 'Users',
                  action: 'SwapPage_connected_wallet_button_pushed',
                })
                toggleWalletDrawer()
              }}
              fontWeight={535}
          ...
          chainId && chainId !== connectedChainId ? (
            ...
            <ButtonError
              onClick={() => {
                ReactGA.event({
                  category: 'Users',
                  action: 'Swap_tokens_button_pushed',
                })
